...
import main.client.Images;
import main.client.events.GalleryUpdatedEvent;
import main.client.events.GalleryUpdatedEventHandler;
import main.client.services.UserImageService;
import main.client.services.UserImageServiceAsync;
...
public class PhotoGallery extends Composite implements GalleryUpdatedEventHandler {
	...
	public PhotoGallery(Images images) {
		this.parent = images;
